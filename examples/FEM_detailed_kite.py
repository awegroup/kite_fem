...
# kite.solve(fe=fe, max_iterations=2000, tolerance=0.01, step_limit=.005, relax_init=.25, relax_min=0.00, relax_update=0.998, k_update=1,I_stiffness=15)
save_path = PROJECT_DIR / "results" / f"{kite_name}_fem_result.pkl"
save_path.parent.mkdir(parents=True, exist_ok=True)
# save_fem_structure_simple(kite, save_path)
...
kite = load_fem_structure_simple(save_path)
